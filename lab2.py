...
# --------- FIX FOR MATPLOTLIB (NO TKINTER GUI) ----------
import matplotlib
matplotlib.use("Agg")
...
# -------------------------------------------------------
# Q2: FEATURE MATRIX WITH CLASSIFIER
# -------------------------------------------------------
...
# -------------------------------------------------------
# Q7: HEATMAPS (JC, SMC, COS) — SAVED TO FILE
# -------------------------------------------------------
